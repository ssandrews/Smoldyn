...
void smolSetLogging(FILE *logfile,
                    void (*logFunction)(simptr, int, const char *, ...));
void smolSetThrowing(int corethreshold, int libthreshold);
void smolSetError(const char *errorfunction, enum ErrorCode errorcode,
                  const char *errorstring);
void smolSetErrorNT(const char *errorfunction, enum ErrorCode errorcode,
                    const char *errorstring);
enum ErrorCode smolGetError(char *errorfunction, char *errorstring,
                            int clearerror);
...
simptr smolPrepareSimFromFile(const char *filepath, const char *filename,
                              const char *flags);
enum ErrorCode smolLoadSimFromFile(const char *filepath, const char *filename,
                                   simptr *simpointer, const char *flags);
enum ErrorCode smolReadConfigString(simptr sim, const char *statement,
                                    char *parameters);

/***************************** Simulation settings ****************************/

enum ErrorCode smolSetSimTimes(simptr sim, double timestart, double timestop,
                               double timestep);
...
enum ErrorCode smolSetTiffParams(simptr sim, int timesteps,
                                 const char *tiffname, int lowcount,
                                 int highcount);
...
enum ErrorCode smolAddCommand(simptr sim, char type, double on, double off,
                              double step, double multiplier,
                              const char *commandstring);
enum ErrorCode smolAddCommandFromString(simptr sim, char *string);

/********************************* Molecules **********************************/

enum ErrorCode smolAddSpecies(simptr sim, const char *species,
                              const char *mollist);
...
enum ErrorCode smolSetSpeciesMobility(simptr sim, const char *species,
                                      enum MolecState state, double difc,
...
enum ErrorCode smolSetMolList(simptr sim, const char *species,
...
enum ErrorCode smolAddSolutionMolecules(simptr sim, const char *species,
                                        int number, double *lowposition,
                                        double *highposition);
enum ErrorCode smolAddCompartmentMolecules(simptr sim, const char *species,
                                           int number, const char *compartment);
enum ErrorCode smolAddSurfaceMolecules(simptr sim, const char *species,
                                       enum MolecState state, int number,
                                       const char *surface,
                                       enum PanelShape panelshape,
                                       const char *panel, double *position);
int smolGetMoleculeCount(simptr sim, const char *species,
...
enum ErrorCode smolSetBoundaryType(simptr sim, int dimension, int highside,
                                   char type);
...
enum ErrorCode smolSetSurfaceRate(simptr sim, const char *surface,
                                  ...
                                  enum MolecState state1,
                                  enum MolecState state2, double rate,
...
enum ErrorCode smolAddPanel(simptr sim, const char *surface,
                            ...
                            const char *axisstring, double *params);
...
int smolGetPanelIndexNT(simptr sim, const char *surface,
                        enum PanelShape *panelshapeptr, const char *panel);
char *smolGetPanelName(simptr sim, const char *surface,
                       enum PanelShape panelshape, int panelindex, char *panel);
enum ErrorCode smolSetPanelJump(simptr sim, const char *surface,
                                const char *panel1, enum PanelFace face1,
                                const char *panel2, enum PanelFace face2,
                                int isbidirectional);
enum ErrorCode smolAddSurfaceUnboundedEmitter(simptr sim, const char *surface,
                                              enum PanelFace face,
                                              const char *species,
                                              double emitamount,
                                              double *emitposition);
enum ErrorCode smolSetSurfaceSimParams(simptr sim, const char *parameter,
                                       double value);
enum ErrorCode smolAddPanelNeighbor(simptr sim, const char *surface1,
                                    const char *panel1, const char *surface2,
                                    const char *panel2, int reciprocal);
enum ErrorCode smolSetSurfaceStyle(simptr sim, const char *surface,
                                   enum PanelFace face, enum DrawMode mode,
                                   double thickness, double *color,
...
char *smolGetCompartmentName(simptr sim, int compartmentindex,
                             char *compartment);
enum ErrorCode smolAddCompartmentSurface(simptr sim, const char *compartment,
                                         const char *surface);
enum ErrorCode smolAddCompartmentPoint(simptr sim, const char *compartment,
                                       double *point);
enum ErrorCode smolAddCompartmentLogic(simptr sim, const char *compartment,
                                       enum CmptLogic logic,
                                       const char *compartment2);

/********************************* Reactions **********************************/

enum ErrorCode smolAddReaction(simptr sim, const char *reaction,
                               const char *reactant1, enum MolecState rstate1,
                               const char *reactant2, enum MolecState rstate2,
                               int nproduct, const char **productspecies,
...
enum ErrorCode smolSetReactionProducts(simptr sim, const char *reaction,
                                       enum RevParam method, double parameter,
                                       const char *product, double *position);

/************************************ Ports ***********************************/

enum ErrorCode smolAddPort(simptr sim, const char *port, const char *surface,
                           enum PanelFace face);
...
enum ErrorCode smolAddPortMolecules(simptr sim, const char *port, int nmolec,
                                    const char *species, double **positions);
...
enum ErrorCode smolAddLattice(simptr sim, const char *lattice,
                              ...
                              const double *dx, const char *btype);
...
enum ErrorCode smolAddLatticeMolecules(simptr sim, const char *lattice,
                                       const char *species, int number,
                                       double *lowposition,
                                       double *highposition);
enum ErrorCode smolAddLatticeReaction(simptr sim, const char *lattice,
                                      const char *reaction, const int move);
