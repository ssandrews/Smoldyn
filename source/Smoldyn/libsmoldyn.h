...
enum ErrorCode smolLoadSimFromFile(
...
enum ErrorCode smolSetTiffParams(
...
enum ErrorCode smolAddSolutionMolecules(simptr sim, const char *species, int number,
...
enum ErrorCode smolSetPanelJump(simptr sim, const char *surface, const char *panel1,
    enum PanelFace face1, const char *panel2, enum PanelFace face2, int isbidirectional);
...
enum ErrorCode smolAddPanelNeighbor(simptr sim, const char *surface1, const char *panel1,
    const char *surface2, const char *panel2, int reciprocal);
enum ErrorCode smolSetSurfaceStyle(simptr sim, const char *surface, enum PanelFace face,
    enum DrawMode mode, double thickness, double *color, int stipplefactor,
...
enum ErrorCode smolAddCompartmentLogic(
...
enum ErrorCode smolSetReactionRegion(
...
enum ErrorCode smolAddLattice(simptr sim, const char *lattice, const double *min,
