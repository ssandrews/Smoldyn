...
enum ErrorCode smolReadConfigString(
...
enum ErrorCode smolSetGraphicsParams(
...
enum ErrorCode smolAddOutputFile(
...
enum ErrorCode smolSetBoundaryType(
...
enum ErrorCode smolAddSurfaceUnboundedEmitter(simptr sim, const char *surface,
    enum PanelFace face, const char *species, double emitamount,
    double *emitposition);
...
enum ErrorCode smolAddLatticePort(
