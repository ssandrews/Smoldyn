...
PYBIND11_MODULE(_smoldyn, m)
{
    ...
    py::class_<graphicssuperstruct>(m, "Graphics")
      ...
      .def_readonly("gridPoints",
                    &graphicssuperstruct::gridpts) // thickness of virtual box
                                                   // grid for graphics
    ...
    py::class_<Simulation>(m, "Simulation")
      ...
      .def(
        "getSimPtr", &Simulation::getSimPtr, py::return_value_policy::reference)
      ...
      .def("addReaction",
           [](Simulation& sim,
              ...
              double rate                        // rate
               ...
               // str/unicode fiasco. Be safe, use string and cast to const
               // char* by ourselves.
