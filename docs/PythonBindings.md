...
s.setSurfaceAction("Membrane00", PF.both, "ATP"
    , MS.soln, SA.reflect)
...
s.addSurfaceMolecules("ACA", MS.down, 30
    , "Membrane00", PS.all, "all", [])
s.addSurfaceMolecules("cAR1", MS.up, 30
    , "Membrane00", PS.all, "all", [])
s.addReaction("r100", "", MS.all, "", MS.all
    , 1, ["ATP"], [MS.soln], 0.02)
