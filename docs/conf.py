...
is_readthedoc = os.environ.get("READTHEDOCS") is None
print(f"{is_readthedoc=}")
if not is_readthedoc:
    sys.path.insert(0, str(sdir_ / ".." / "source" / "python"))
    sys.path.insert(0, str(sdir_ / ".." / "examples" / "S15_python"))
else:
    print("READTHEDOCS is True")

print("sys.path ", sys.path)
import smoldyn  # noqa: E402
...
project = "Smoldyn"
copyright = f"{date.today().year} , Steven S. Andrews"
