...
% Chapter: Documentation and websites
\chapter{Documentation and websites}

The Smoldyn web site, www.smoldyn.org, is the principle download site. It also contains a decent amount of information about Smoldyn and other spatial simulators in the ``About'' section.

The user's manual, SmoldynUserManual.pdf, is created from a Microsoft Word file. This file describes how to use the software, aimed at the stand-alone software, but is reasonably complete and readable.

The code documentation, SmoldynCodeDoc.pdf, is created from a LaTeX file. This is a thorough description of the C code, including descriptions of all data structures and functions.

The library documentation, LibsmoldynManual.pdf, is created from a LaTeX file. It tells how to use the C/C++ API to Smoldyn. It also describes the new Python bindings.

Smoldyn can also be downloaded from the Python site: https://pypi.org/project/smoldyn/.

The readthedocs website has information about the Smoldyn code, created using Doxygen: https://smoldyn.readthedocs.io/en/latest/doxygen/html/classes.html.

Smoldyn's code repository is on Github, at https://github.com/ssandrews/Smoldyn-official.
