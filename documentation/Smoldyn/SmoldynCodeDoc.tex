...
Within the python subdirectory, additional targets are: \texttt{wheel}, \texttt{pyinstall}, \texttt{pyinstall\_venv}, \texttt{pyuninstall}, \texttt{pydevel}, and \texttt{doc\_api\_html}.
