...
c1 = sm.Cylinder(start=[-3, 0, 0], end=[3, 0, 0], radius=2, slices=10, stacks=5)
...
ecoli.addMolecules((red, "up"), mol=1000, panels=ecoli.panels)
ecoli.addMolecules((green, "up"), mol=1000, panels=ecoli.panels)

s = sm.Simulation(100, 0.1, output_files=["2Dreactout.txt"])
