...
s1.both.addAction(species='all', action='reflect')

rxn = S.Reaction(name='stick',subs=[blue,red],prds=[red,red],rate=20)
rxn.productPlacement(method='bounce',parameter=0.6)
